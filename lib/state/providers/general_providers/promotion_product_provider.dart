...
final promotionProductProvider =
    StreamProvider.family.autoDispose<List<ProductModel>, String>((
  ref,
  String category,
) {
  ...
  final sub = FirebaseFirestore.instance
      ...
      .where('promotion', isEqualTo: true)
      .snapshots()
      .listen((snapshot) {
    final document = snapshot.docs;
    final products = document.map((doc) => ProductModel.fromJson(doc)).toList();
